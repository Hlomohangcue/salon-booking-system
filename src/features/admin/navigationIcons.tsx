/**
 * Inline SVG icon set for the admin navigation.
 * Each icon is a small presentational component that accepts a className
 * so it can be sized/coloured by its parent (the sidebar link).
 */
